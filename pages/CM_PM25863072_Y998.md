...
### Description
This model describes the binding and phosphorilation of EGFR by many different proteins which can bind to six different receptors. This ModelBrick describes the binding of proteins to the 998 receptor. A complete description can be found in the paper linked at the publication section.  

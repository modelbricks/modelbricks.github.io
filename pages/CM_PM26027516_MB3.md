...
This Brick describes the activation of PKA. PKA is a tetramer conformed by two catalytic subunits and two regulatory subunits. The model proposes the activation of the catalytic subunits and allows the regulatory subunits to bind cAMP forming PKA2reg_cAMP(two regulatory subunits binding cAMP) to be later removed from the complex by PDE.
...
<center>
 <table>
  ...
  <tr>
   ...
   <td bgcolor="#EBF5FB"><!--<a href="/modelbricks/VCML_SBMLfiles/CM_PM26027516_MB3.xml" download>CM_PM26027516_MB3.xml</a>--></td>

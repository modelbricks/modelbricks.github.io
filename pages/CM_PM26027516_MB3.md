...
This Brick describes the activation of PKA. PKA is a tetramer conformed by two catalytic subunits and two regulatory subunits. The model proposes the activation of the catalytic subunits and allows the regulatory subunits to bind cAMP forming PKA2reg_cAMP(teo regulatpry suunits binding cAMP) to be later removed from the complex by PDE.

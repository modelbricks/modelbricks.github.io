...
### Description
This ModelBrick from the article, "Sniffers, buzzers, toggles and blinkers..." describes negative feedback (X activates Y through phosphorylation, phospho-Y in turn activates R through phosphorylation, with phospho-R degrading X) creating an oscillatory response.

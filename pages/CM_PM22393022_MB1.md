...
### Description
This ModelBrick belongs to the reduced model of the auxin gravaitropism. It takes into account 3 main reactin a) the production of the reported protein construct VENUS, its degradation by photobleaching and by auxin action. For simulation the doses of auxin has been set at different concentration where:
<table>
 <th> qj_start </th>
 <th> auxin (nM) </th>
 <tr><td>1.00</td>
 ...
 <tr>
  ...
  <tr>
   <td align="center">
    ...
    <img align="center" src="/images/Vcellimages/CM_PM22393022_MB1_Vcell_sim.PNG"   widht="80%"Height="180"/></a></td> 
   <td align="center" widht="50%">

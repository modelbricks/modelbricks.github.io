...
<center>
 ...
 <tr>
  <td align="center"> Vcell simulation results. A) cAMP and PKA concentrations over time run with Gs initial concentration set at 0.38 uM B) Total pPLB concentration respect AKAP, PLB initial concentration set at 50uM </td>
   <td align="center"> Publication figure 5A and 5B</td>
 </tr>
 </table>
</center>

There is a difference between the simulations in the curated model compare to the figures 5A and B in the publication mainly because the publication does not specify all the parameters for this figures and the authors of the original model had tried different parameters which are available in the published Biomodels folder in VCell. 
### Downloads
<center>
 <table>

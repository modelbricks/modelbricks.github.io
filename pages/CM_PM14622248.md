...
<center>
 ...
 <tr>
  <td align="center"> Ligand concentration dependent plot based on Vcell simulation. </br> Simulation run for 10000s in VCell, and the last output flux for Cisthationine and Threonine were used to plot against adenosylmethionine concentration (range 0-100uM). Plot was made using Excel.</td>

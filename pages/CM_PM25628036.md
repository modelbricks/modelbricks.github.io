...
<center>
 <table style="border-collapse:separate; border-spacing:0 5px;">
  <td width="25%">VCell curated model </td>
  <td width="25%"><a href="/modelbricks/VCML_SBMLfiles/CM_PM25628036.vcml">CM_PM25628036.vcml</a></td>
  <td width="25%"> designed with <a href="http://vcell.org"> VCell</a></td>
  <tr>
   <td>SBML original </td>
